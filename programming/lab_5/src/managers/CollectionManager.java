...
public class CollectionManager {
    ...
    public void removeFirst() {this.collection.remove();}
    public HumanBeing removeHead() {return this.collection.poll();}
    public void clear(){
    ...
    public void readCollection(String path){
        this.collection = (ArrayDeque<HumanBeing>) jsonManager.readFile(path);
